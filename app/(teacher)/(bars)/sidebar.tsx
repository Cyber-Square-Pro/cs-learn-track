...
export const SidebarPage = () => {
  return (
    <div>
      <div className="relative  box-border  h-dvh bg-[#0a0a0a]">
        <div className="w-64 p-6 space-y-4 text-white ">
          <div className="flex flex-col h-dvh w-52">
            ...
            <div className="relative h-2 mt-auto  signDiv"></div>
          </div>
        </div>
      </div>
    </div>
